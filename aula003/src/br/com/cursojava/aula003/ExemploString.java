...
public class ExemploString {
	public static void main(String[] args) {
		...
		//replace irá pegar o valor antigo, ali " "(os espaços), e altera por um novo ""(sem espaço)
		...
		//indexOf é a posição inicial que a palavra começa no texto
		...
		// subString irá buscar apenas o que é posterio ao index informado, ou o que está dentro do index informado
		...
		//busca o caracter da posição informada
		...
		//compara strings e ignora se é maiúsculo ou minúsculo
		...
		//trim retira espaços antes e depois das palavras;
		//split ele corta fora o que esta informado (no caso ";" irá retirar todos os ; e pular linha com o que está depois do ; (utiliza arrey))
