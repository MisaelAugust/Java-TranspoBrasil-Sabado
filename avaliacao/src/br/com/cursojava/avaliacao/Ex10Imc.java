...
public class Ex10Imc {
	public static void main(String[] args) {
		...
		if (imc >= 17 && imc <= 18.49){
			System.out.printf("Abaixo do peso, sua idade é %d e seu imc é %f",idade, imc);
		}else if(imc >= 18.50 && imc < 25){
			System.out.printf("Peso normal, sua idade é %d e seu imc é %f",idade, imc);
		}else if(imc >= 25 && imc < 30){
			System.out.printf("Acima do peso, sua idade é %d e seu imc é %f",idade, imc);
		}else if(imc >= 30 && imc < 40){
			System.out.printf("Obesidade I, sua idade é %d e seu imc é %f",idade, imc);
		}else{
			System.out.printf("Obesidade morbida, sua idade é %d e seu imc é %f",idade, imc);
		}
		tecladoEx10.close();
	}
}
