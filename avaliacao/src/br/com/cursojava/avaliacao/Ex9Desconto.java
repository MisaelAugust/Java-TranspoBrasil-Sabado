...
o percentual de desconto e o valor líquido;
...
public class Ex9Desconto {
	public static void main(String[] args) {
		...
		if(valor <= 1800){
			...
			System.out.printf("O valor do produto é %.2f, o percentual de desconto é %d, "
					+ "o desconto é de %.2f, e o valor com o desconto é %.2f", valor,porcentagem, desconto, totalValor);
